    ...
    [482], {
        9482: function(t, e, i) {
            ...
            let {
                ...
                state: R,
                steps: L
            } = C("undefined" != typeof requestAnimationFrame ? requestAnimationFrame : M, !0), F = (t, e, i) => (((1 - 3 * i + 3 * e) * t + (3 * i - 6 * e)) * t + 3 * e) * t;
            ...
            class tA {
                ...
                scheduleResolve() {
                    this.isScheduled = !0, this.isAsync ? (tP.add(this), tb || (tb = !0, k.read(tS), k.resolveKeyframes(tT))) : (this.readKeyframes(), this.complete())
                }
                readKeyframes() {
                    let {
            ...
            let tV = t => Math.round(1e5 * t) / 1e5,
                ...
                tL = {
                    ...
                    transform: ({
                        ...
                        blue: i,
                        alpha: n = 1
                    }) => "rgba(" + tR.transform(t) + ", " + tR.transform(e) + ", " + tR.transform(i) + ", " + tV(te.transform(n)) + ")"
                },
                tF = {
                    test: tC("#"),
                    parse: function(t) {
                ...
                tj = {
                    ...
                    transform: ({
                        ...
                        lightness: i,
                        alpha: n = 1
                    }) => "hsla(" + Math.round(t) + ", " + ts.transform(tV(e)) + ", " + ts.transform(tV(i)) + ", " + tV(te.transform(n)) + ")"
                },
                tB = {
                    test: t => tL.test(t) || tF.test(t) || tj.test(t),
                    parse: t => tL.test(t) ? tL.parse(t) : tj.test(t) ? tj.parse(t) : tF.parse(t),
                    transform: t => "string" == typeof t ? t : t.hasOwnProperty("red") ? tL.transform(t) : tj.transform(t)
                },
            ...
            function tN(t) {
                let e = t.toString(),
                    ...
                    r = [],
                    s = 0,
                    o = e.replace(t$, t => (tB.test(t) ? (n.color.push(s), r.push(tU), i.push(tB.parse(t))) : t.startsWith("var(") ? (n.var.push(s), r.push("var"), i.push(t)) : (n.number.push(s), r.push(tI), i.push(parseFloat(t))), ++s, "${}")).split("${}");
                return {
                    values: i,
                    split: o,
                    indexes: n,
            ...
            function tz(t) {
                ...
                return t => {
                    ...
                    for (let s = 0; s < n; s++)
                        if (r += e[s], void 0 !== t[s]) {
                            let e = i[s];
                            e === tI ? r += tV(t[s]) : e === tU ? r += tB.transform(t[s]) : r += t[s]
                        } return r
                }
            }
            ...
            function t0(t, e) {
                let i = tQ(t);
                return i !== tq && (i = tY), i.getAnimatableNone ? i.getAnimatableNone(e) : void 0
            }
            ...
            class t5 extends tA {
                ...
                readKeyframes() {
                    ...
                    for (let i = 0; i < t.length; i++) {
                        let n = t[i];
                        if ("string" == typeof n && _(n = n.trim())) {
                            let r = function t(e, i, n = 1) {
                                M(n <= 4, `Max CSS variable fallback depth detected in property "${e}". This may indicate a circular fallback dependency.`);
                                let [r, s] = function(t) {
                                    let e = J.exec(t);
                                    if (!e) return [, ];
                                    let [, i, n, r] = e;
                                ...
                                if (o) {
                                    let t = o.trim();
                                    return G(t) ? parseFloat(t) : t
                                }
                                return _(s) ? t(s, i, n + 1) : s
                            }(n, e.current);
                ...
                resolveNoneKeyframes() {
                    ...
                    for (let e = 0; e < t.length; e++) {
                        var n;
                        ("number" == typeof(n = t[e]) ? 0 === n : null === n || "none" === n || "0" === n || Y(n)) && i.push(e)
                    }
            ...
            let t9 = {
                    now: () => (void 0 === n && t9.set(R.isProcessing || T.useManualTiming ? R.timestamp : performance.now()), n),
                    set: t => {
                        n = t, queueMicrotask(t3)
                    }
                },
                t4 = (t, e) => "zIndex" !== e && !!("number" == typeof t || Array.isArray(t) || "string" == typeof t && (tY.test(t) || "0" === t) && !t.startsWith("url("));
            class t6 {
                constructor({
                    autoplay: t = !0,
                    delay: e = 0,
                ...
                onKeyframesResolved(t, e) {
                    ...
                    if (!l && ! function(t, e, i, n) {
                            ...
                            let s = t[t.length - 1],
                                o = t4(r, e),
                                a = t4(s, e);
                            return M(o === a, `You are trying to animate ${e} from "${r}" to "${s}". ${r} is not an animatable value - to enable this animation set ${r} to a value animatable to ${s} via the \`style\` property.`), !!o && !!a && (function(t) {
                                let e = t[0];
                        ...
                        if (S.current || !s) {
                            null == a || a(V(t, this.options, e)), null == o || o(), this.resolveFinishedPromise();
                            return
                        }
            ...
            let es = j(.42, 0, 1, 1),
                ...
                ec = t => {
                    ...
                    return "string" == typeof t ? (M(void 0 !== eh[t], `Invalid easing type '${t}'`), eh[t]) : t
                },
                ed = (t, e) => i => e(t(i)),
                ep = (...t) => t.reduce(ed),
                em = (t, e, i) => {
            ...
            function eb(t) {
                let e = eP(t);
                if (M(!!e, `'${t}' is not an animatable color. Use the equivalent color code instead.`), !e) return !1;
                let i = e.parse(t);
                return e === tj && (i = function({
                    hue: t,
                    saturation: e,
                    lightness: i,
                    alpha: n
            ...
            let ew = (t, e) => {
                    ...
                    return t => (r.red = ey(i.red, n.red, t), r.green = ey(i.green, n.green, t), r.blue = ey(i.blue, n.blue, t), r.alpha = ef(i.alpha, n.alpha, t), tL.transform(r))
                },
            ...
            function eA(t) {
                return "number" == typeof t ? eS : "string" == typeof t ? _(t) ? eg : tB.test(t) ? ew : eE : Array.isArray(t) ? eV : "object" == typeof t ? tB.test(t) ? ew : eM : eg
            }
            ...
            let eE = (t, e) => {
                let i = tY.createTransformer(e),
                    n = tN(t),
                    r = tN(e);
                return n.indexes.var.length === r.indexes.var.length && n.indexes.color.length === r.indexes.color.length && n.indexes.number.length >= r.indexes.number.length ? eT.has(t) && !r.values.length || eT.has(e) && !n.values.length ? eT.has(t) ? i => i <= 0 ? t : e : i => i >= 1 ? e : t : ep(eV(function(t, e) {
                    var i;
                    let n = [],
                        r = {
                            color: 0,
                    ...
                    return n
                }(n, r), r.values), i) : (M(!0, `Complex values '${t}' and '${e}' too different to mix. Ensure all colors are of the same type, and that each contains the same quantity of number and color values. Falling back to instant transition.`), eg(t, e))
            };
            ...
            function ek({
                ...
                let r = el(n) ? n.map(ec) : ec(n),
                    ...
                    o = function(t, e, {
                        ...
                        let s = t.length;
                        if (M(s === e.length, "Both input and output ranges must be the same length"), 1 === s) return () => e[0];
                        ...
                        let o = function(t, e, i) {
                                ...
                                for (let i = 0; i < s; i++) {
                                    let s = r(t[i], t[i + 1]);
                                    e && (s = ep(Array.isArray(e) ? e[i] || M : e, s)), n.push(s)
                                }
                                return n
                            }(e, n, r),
                            a = o.length,
            ...
            let eD = t => {
                    ...
                    return {
                        start: () => k.update(e, !0),
                        stop: () => D(e),
                        now: () => R.isProcessing ? R.timestamp : t9.now()
                    }
                },
                eR = {
                    decay: er,
            ...
            class eF extends t6 {
                ...
                initPlayback(t) {
                    ...
                    let {
                        ...
                        repeatType: o,
                        velocity: a = 0
                    } = this.options, l = t2(n) ? n : eR[n] || ek;
                    l !== ek && "number" != typeof t[0] && (e = ep(eL, eC(t[0], t[1])), t = [0, 100]);
                    let u = l({
                        ...this.options,
                        keyframes: t
                    });
                ...
                tick(t, e = !1) {
                    ...
                    if (d) {
                        let t = Math.min(this.currentTime, u) / h,
                            e = Math.floor(t),
                            i = t % 1;
                        !i && t >= 1 && (i = 1), 1 === i && e--, (e = Math.min(e, d + 1)) % 2 && ("reverse" === p ? (i = 1 - i, m && (i -= m / h)) : "mirror" === p && (x = s)), y = Q(0, 1, i) * h
                    }
                    let P = g ? {
                        done: !1,
                        value: a[0]
                    ...
                    return w && void 0 !== n && (P.value = V(a, this.options, n)), f && f(P.value), w && this.finish(), P
                }
                get duration() {
                    let {
                        resolved: t
            ...
            class eY extends t6 {
                constructor(t) {
                    ...
                    this.resolver = new t5(r, (t, e) => this.onKeyframesResolved(t, e), e, i, n), this.resolver.scheduleResolve()
                }
                initPlayback(t, e) {
                    var i, n;
                    let {
                    ...
                    if ("string" == typeof o && eU() && o in eH && (o = eH[o]), t2((n = this.options).type) || "spring" === n.type || ! function t(e) {
                    ...
                    let c = function(t, e, i, {
                        ...
                        let h = function t(e, i) {
                            if (e) return "function" == typeof e && eU() ? eB(e, i) : eu(e) ? e$(e) : Array.isArray(e) ? e.map(e => t(e, i) || eN.easeOut) : eN[e]
                        }(a, r);
                    ...
                    return c.startTime = null != h ? h : this.calcStartTime(), this.pendingTimeline ? (eW(c, this.pendingTimeline), this.pendingTimeline = void 0) : c.onfinish = () => {
                        let {
                            onComplete: i
                        } = this.options;
                        l.set(V(t, this.options, e)), i && i(), this.cancel(), this.resolveFinishedPromise()
                    }, {
                        animation: c,
                        duration: r,
                        times: s,
                ...
                static supports(t) {
                    ...
                    return ez() && i && ej.has(i) && e && e.owner && e.owner.current instanceof HTMLElement && !e.owner.getProps().onUpdate && !n && "mirror" !== r && 0 !== s && "inertia" !== o
                }
            }
            let eG = eO(() => void 0 !== window.ScrollTimeline);
            class eX {
                constructor(t) {
                ...
                attachTimeline(t, e) {
                    let i = this.animations.map(i => eG() && i.attachTimeline ? i.attachTimeline(t) : e(i));
                    return () => {
                        i.forEach((t, e) => {
            ...
            let eK = (t, e, i, n = {}, r, s) => o => {
                    ...
                    let c = !1;
                    if (!1 !== h.type && (0 !== h.duration || h.repeatDelay) || (h.duration = 0, 0 !== h.delay || (c = !0)), (S.current || T.skipAnimations) && (c = !0, h.duration = 0, h.delay = 0), c && !s && void 0 !== e.get()) {
                        let t = V(h.keyframes, a);
                        if (void 0 !== t) return k.update(() => {
                            h.onUpdate(t), h.onComplete()
                        }), new eX([])
                    }
                    return !s && eY.supports(h) ? new eY(h) : new eF(h)
                },
            ...
            function e8(t, e, {
                ...
                for (let e in l) {
                    ...
                    e6(t, e), n.start(eK(e, n, r, t.shouldReduceMotion && m.has(e) ? {
                        type: !1
                    } : a, t, h));
                    let d = n.animation;
                    d && u.push(d)
                        ...
                        function u(u) {
                            ...
                            for (let e = 0; e < ir; e++) {
                                ...
                                for (let t in C) {
                                    let e = M[t],
                                        i = E[t];
                                    if (!f.hasOwnProperty(t))(s(e) && s(i) ? o(e, i) : e === i) ? void 0 !== e && m.has(t) ? k(t) : y.protectedKeys[t] = !0 : null != e ? k(t) : m.add(t)
                                }
                                y.prevProp = x, y.prevResolvedValues = M, y.isActive && (f = {
                                    ...f,
                                    ...M
            ...
            let ic = t => "mouse" === t.pointerType ? "number" != typeof t.button || t.button <= 0 : !1 !== t.isPrimary;
            ...
            class iy {
                constructor(t, e, {
                    ...
                    if (this.startEvent = null, this.lastMoveEvent = null, this.lastMoveEventInfo = null, this.handlers = {}, this.contextWindow = window, this.updatePoint = () => {
                            ...
                            this.lastMoveEvent = t, this.lastMoveEventInfo = ix(e, this.transformPagePoint), k.update(this.updatePoint, !0)
                    ...
                    let s = ix(id(t), this.transformPagePoint),
                        {
                            point: o
                        } = s,
                        {
            ...
            function ik(t, e, i, n = .5) {
                t.origin = n, t.originPoint = ef(e.min, e.max, t.origin), t.scale = iC(i) / iC(e), t.translate = ef(i.min, i.max, t.origin) - t.originPoint, (t.scale >= .9999 && t.scale <= 1.0001 || isNaN(t.scale)) && (t.scale = 1), (t.translate >= -.01 && t.translate <= .01 || isNaN(t.translate)) && (t.translate = 0)
            }
            ...
            function iX(t) {
                return iG(t) || iK(t) || t.z || t.rotate || t.rotateX || t.rotateY || t.skewX || t.skewY
            }
            ...
            function iZ(t, {
                ...
                i_(t.x, e.translate, e.scale, e.originPoint), i_(t.y, i.translate, i.scale, i.originPoint)
            }
            ...
            class i3 {
                ...
                start(t, {
                    ...
                    this.panSession = new iy(t, {
                        onSessionStart: t => {
                            ...
                            i ? this.pauseAnimation() : this.stopAnimation(), e && this.snapToCursor(id(t, "page").point)
                        },
                        onStart: (t, e) => {
                            let {
                                drag: i,
                            ...
                            if (i && !n && (this.openGlobalLock && this.openGlobalLock(), this.openGlobalLock = iV(i), !this.openGlobalLock)) return;
                            this.isDragging = !0, this.currentDirection = null, this.resolveConstraints(), this.visualElement.projection && (this.visualElement.projection.isAnimationBlocked = !0, this.visualElement.projection.target = void 0), iz(t => {
                            ...
                            }), r && k.postRender(() => r(t, e)), e6(this.visualElement, "transform");
                            let {
                                animationState: s
                            } = this.visualElement;
                ...
                resolveConstraints() {
                    ...
                    e && iE(e) ? this.constraints || (this.constraints = this.resolveRefConstraints()) : e && n ? this.constraints = function(t, {
                        top: e,
                        left: i,
                        bottom: n,
                        right: r
                    ...
                    }(i), r !== this.constraints && n && this.constraints && !this.hasMutatedConstraints && iz(t => {
                ...
                resolveRefConstraints() {
                    ...
                    if (!e || !iE(e)) return !1;
                    let n = e.current;
                    M(null !== n, "If `dragConstraints` is set as a React ref, that ref must be passed to another component's `ref` prop.");
                    let {
                        projection: r
                    } = this.visualElement;
                    ...
                    let s = function(t, e, i) {
                        ...
                        o = {
                            x: iB((t = r.layout.layoutBox).x, s.x),
                            y: iB(t.y, s.y)
                        };
                    if (i) {
                        let t = i(function({
                ...
                startAxisValueAnimation(t, e) {
                    ...
                    return e6(this.visualElement, t), i.start(eK(t, i, 0, e, this.visualElement, !1))
                }
                stopAnimation() {
                ...
                scalePositionWithinConstraints() {
                    ...
                    this.visualElement.current.style.transform = r ? r({}, "") : "none", i.root && i.root.updateScroll(), i.updateLayout(), this.resolveConstraints(), iz(e => {
            ...
            class i4 extends ia {
                constructor(t) {
                    super(t), this.removeGroupControls = M, this.removeListeners = M, this.controls = new i3(t)
                }
                mount() {
                    let {
                        dragControls: t
                    } = this.node.getProps();
                    t && (this.removeGroupControls = t.subscribe(this.controls)), this.removeListeners = this.controls.addListeners() || M
                }
                unmount() {
            ...
            class np extends nn.Component {
                ...
                getSnapshotBeforeUpdate(t) {
                    ...
                    return s && (s.isPresent = r, n || t.layoutDependency !== e || void 0 === e ? s.willUpdate() : this.safeToRemove(), t.isPresent === r || (r ? s.promote() : s.relegate() || k.postRender(() => {
                        let t = s.getStack();
                ...
                componentDidUpdate() {
                    ...
                    t && (t.root.didUpdate(), nc.postRender(() => {
            ...
            function nE(t, e, [i, n, r], s, o) {
                ! function(t, e = 0, i = 1, n = .5, r, s = t, o = t) {
                    ...
                    t === s && (a -= e), t.min = nM(t.min, e, i, a, r), t.max = nM(t.max, e, i, a, r)
            ...
            function nD(t, e, i, n) {
                nE(t.x, e, nC, i ? i.x : void 0, n ? n.x : void 0), nE(t.y, e, nk, i ? i.y : void 0, n ? n.y : void 0)
            }
            ...
            function nq({
                ...
                return class {
                    constructor(t = {}, i = null == e ? void 0 : e()) {
                        this.id = nX++, this.animationId = 0, this.children = new Set, this.options = {}, this.isTreeAnimating = !1, this.isAnimationBlocked = !1, this.isLayoutDirty = !1, this.isProjectionDirty = !1, this.isSharedProjectionDirty = !1, this.isTransformDirty = !1, this.updateManuallyBlocked = !1, this.updateBlockedByResize = !1, this.isUpdating = !1, this.isSVG = !1, this.needsReset = !1, this.shouldResetTransform = !1, this.hasCheckedOptimisedAppear = !1, this.treeScale = {
                            x: 1,
                            y: 1
                        }, this.eventHandlers = new Map, this.hasTreeAnimated = !1, this.updateScheduled = !1, this.scheduleUpdate = () => this.update(), this.projectionUpdateScheduled = !1, this.checkUpdateFailed = () => {
                            this.isUpdating && (this.isUpdating = !1, this.clearAllSnapshots())
                        }, this.updateProjection = () => {
                            this.projectionUpdateScheduled = !1, nH && (nz.totalNodes = nz.resolvedTargetDeltas = nz.recalculatedProjection = 0), this.nodes.forEach(nJ), this.nodes.forEach(n9), this.nodes.forEach(n4), this.nodes.forEach(nQ), nH && window.MotionDebug.record(nz)
                        ...
                        if (s && !s.current && s.mount(e), this.root.nodes.add(this), this.parent && this.parent.children.add(this), i && (r || n) && (this.isLayoutDirty = !0), t) {
                            ...
                            t(e, () => {
                                this.root.updateBlockedByResize = !0, i && i(), i = function(t, e) {
                                    ...
                                    return k.read(n, !0), () => D(n)
                                }(n, 0), na.hasAnimatedSinceResize && (na.hasAnimatedSinceResize = !1, this.nodes.forEach(n3))
                            })
                        }
                    ...
                    update() {
                        ...
                        this.isUpdating || this.nodes.forEach(n5), this.isUpdating = !1, this.nodes.forEach(n2), this.nodes.forEach(n_), this.nodes.forEach(nZ), this.clearAllSnapshots();
                        let t = t9.now();
                        R.delta = Q(0, 1e3 / 60, t - R.timestamp), R.timestamp = t, R.isProcessing = !0, L.update.process(R), L.preRender.process(R), L.render.process(R), R.isProcessing = !1
                    }
                    didUpdate() {
                        this.updateScheduled || (this.updateScheduled = !0, nc.read(this.scheduleUpdate))
                    }
                    clearAllSnapshots() {
                    ...
                    resetTransform() {
                        ...
                        t && (e || iX(this.latestValues) || s) && (r(this.instance, n), this.shouldResetTransform = !1, this.scheduleRender())
                    }
                    measure(t = !0) {
                        var e;
                    ...
                    applyTransform(t, e = !1) {
                        ...
                        for (let t = 0; t < this.path.length; t++) {
                            ...
                            !e && n.options.layoutScroll && n.scroll && n !== n.root && i0(i, {
                                x: -n.scroll.offset.x,
                                y: -n.scroll.offset.y
                            }), iX(n.latestValues) && i0(i, n.latestValues)
                        }
                        return iX(this.latestValues) && i0(i, this.latestValues), i
                    }
                    removeTransform(t) {
                        let e = iW();
                        nA(e, t);
                        for (let t = 0; t < this.path.length; t++) {
                            ...
                            let n = iW();
                            nA(n, i.measurePageBox()), nD(e, i.latestValues, i.snapshot ? i.snapshot.layoutBox : void 0, n)
                        }
                        return iX(this.latestValues) && nD(e, this.latestValues), e
                    }
                    setTargetDelta(t) {
                    ...
                    resolveTargetDelta(t = !1) {
                        ...
                        if (this.layout && (a || l)) {
                            if (this.resolvedRelativeTargetAt = R.timestamp, !this.targetDelta && !this.relativeTarget) {
                                ...
                                t && t.layout && 1 !== this.animationProgress ? (this.relativeParent = t, this.forceRelativeParentToResolveTarget(), this.relativeTarget = iW(), this.relativeTargetOrigin = iW(), iF(this.relativeTargetOrigin, this.layout.layoutBox, t.layout.layoutBox), nA(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0
                            }
                            if (this.relativeTarget || this.targetDelta) {
                                if ((this.target || (this.target = iW(), this.targetWithTransforms = iW()), this.relativeTarget && this.relativeTargetOrigin && this.relativeParent && this.relativeParent.target) ? (this.forceRelativeParentToResolveTarget(), i = this.target, n = this.relativeTarget, r = this.relativeParent.target, iR(i.x, n.x, r.x), iR(i.y, n.y, r.y)) : this.targetDelta ? (this.resumingFrom ? this.target = this.applyTransform(this.layout.layoutBox) : nA(this.target, this.layout.layoutBox), iZ(this.target, this.targetDelta)) : nA(this.target, this.layout.layoutBox), this.attemptToResolveRelativeTarget) {
                                    this.attemptToResolveRelativeTarget = !1;
                                    let t = this.getClosestProjectingParent();
                                    t && !!t.resumingFrom == !!this.resumingFrom && !t.options.layoutScroll && t.target && 1 !== this.animationProgress ? (this.relativeParent = t, this.forceRelativeParentToResolveTarget(), this.relativeTarget = iW(), this.relativeTargetOrigin = iW(), iF(this.relativeTargetOrigin, this.target, t.target), nA(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0
                                }
                                nH && nz.resolvedTargetDeltas++
                            }
                        }
                    }
                    getClosestProjectingParent() {
                        return !this.parent || iG(this.parent.latestValues) || iK(this.parent.latestValues) ? void 0 : this.parent.isProjecting() ? this.parent : this.parent.getClosestProjectingParent()
                    }
                    isProjecting() {
                    ...
                    calcProjection() {
                        ...
                        let e = this.getLead(),
                            ...
                            n = !0;
                        if ((this.isProjectionDirty || (null === (t = this.parent) || void 0 === t ? void 0 : t.isProjectionDirty)) && (n = !1), i && (this.isSharedProjectionDirty || this.isTransformDirty) && (n = !1), this.resolvedRelativeTargetAt === R.timestamp && (n = !1), n) return;
                        let {
                            layout: r,
                            layoutId: s
                        } = this.options;
                            ...
                            if (o) {
                                ...
                                for (let a = 0; a < o; a++) {
                                    ...
                                    (!o || !o.props.style || "contents" !== o.props.style.display) && (n && r.options.layoutScroll && r.scroll && r !== r.root && i0(t, {
                                        x: -r.scroll.offset.x,
                                        y: -r.scroll.offset.y
                                    }), s && (e.x *= s.x.scale, e.y *= s.y.scale, iZ(t, s)), n && iX(r.latestValues) && i0(t, r.latestValues))
                                }
                        ...
                        this.projectionDelta && this.prevProjectionDelta ? (nV(this.prevProjectionDelta.x, this.projectionDelta.x), nV(this.prevProjectionDelta.y, this.projectionDelta.y)) : this.createProjectionDeltas(), iD(this.projectionDelta, this.layoutCorrected, l, this.latestValues), this.treeScale.x === o && this.treeScale.y === a && nI(this.projectionDelta.x, this.prevProjectionDelta.x) && nI(this.projectionDelta.y, this.prevProjectionDelta.y) || (this.hasProjected = !0, this.scheduleRender(), this.notifyListeners("projectionUpdate", l)), nH && nz.recalculatedProjection++
                    }
                    hide() {
                        this.isVisible = !1
                    }
                    ...
                    setAnimationOrigin(t, e = !1) {
                        ...
                        let a = iW(),
                            ...
                            c = !!(l && !h && !0 === this.options.crossfade && !this.path.some(re));
                        this.animationProgress = 0, this.mixTargetDelta = e => {
                            ...
                            if (n7(o.x, t.x, n), n7(o.y, t.y, n), this.setTargetDelta(o), this.relativeTarget && this.relativeTargetOrigin && this.layout && this.relativeParent && this.relativeParent.layout) {
                                var u, d, p, m;
                                iF(a, this.layout.layoutBox, this.relativeParent.layout.layoutBox), p = this.relativeTarget, m = this.relativeTargetOrigin, rt(p.x, m.x, a.x, n), rt(p.y, m.y, a.y, n), i && (u = this.relativeTarget, d = i, nF(u.x, d.x) && nF(u.y, d.y)) && (this.isProjectionDirty = !1), i || (i = iW()), nA(i, this.relativeTarget)
                            }
                    ...
                    startAnimation(t) {
                        this.notifyListeners("animationStart"), this.currentAnimation && this.currentAnimation.stop(), this.resumingFrom && this.resumingFrom.currentAnimation && this.resumingFrom.currentAnimation.stop(), this.pendingAnimation && (D(this.pendingAnimation), this.pendingAnimation = void 0), this.pendingAnimation = k.update(() => {
                            na.hasAnimatedSinceResize = !0, this.currentAnimation = function(t, e, i) {
                                let n = e4(0) ? 0 : e2(0);
                                return n.start(eK("", n, 1e3, i)), n.animation
                            }(0, 0, {
                                ...t,
                                onUpdate: e => {
                    ...
                    applyTransformsToTarget() {
                        ...
                        if (e && i && n) {
                            ...
                            nA(e, i), i0(e, r), iD(this.projectionDeltaWithTransform, this.layoutCorrected, e, r)
                        }
                    }
                    ...
                    resetSkewAndRotation() {
                        ...
                        for (let e = 0; e < nY.length; e++) nK(`rotate${nY[e]}`, t, n, this.animationValues), nK(`skew${nY[e]}`, t, n, this.animationValues);
                    ...
                    getProjectionStyles(t) {
                        ...
                        if (this.needsReset) return this.needsReset = !1, n.opacity = "", n.pointerEvents = nW(null == t ? void 0 : t.pointerEvents) || "", n.transform = r ? r(this.latestValues, "") : "none", n;
                        let s = this.getLead();
                        if (!this.projectionDelta || !this.layout || !s.target) {
                            let e = {};
                            return this.options.layoutId && (e.opacity = void 0 !== this.latestValues.opacity ? this.latestValues.opacity : 1, e.pointerEvents = nW(null == t ? void 0 : t.pointerEvents) || ""), this.hasProjected && !iX(this.latestValues) && (e.transform = r ? r({}, "") : "none", this.hasProjected = !1), e
                        }
                        ...
                        return this.options.layoutId && (n.pointerEvents = s === this ? nW(null == t ? void 0 : t.pointerEvents) || "" : "none"), n
                    }
                    clearSnapshot() {
                ...
                if (t.isLead() && t.layout && i && t.hasListeners("didUpdate")) {
                    ...
                    if (!t.resumeFrom) {
                        ...
                        if (n && !n.resumeFrom) {
                            ...
                            if (r && s) {
                                let o = iW();
                                iF(o, i.layoutBox, r.layoutBox);
                                let a = iW();
                                iF(a, e, s.layoutBox), nB(o, a) || (u = !0), n.options.layoutRoot && (t.relativeTarget = a, t.relativeTargetOrigin = o, t.relativeParent = n)
                            }
                        }
                    }
            ...
            function nJ(t) {
                nH && nz.totalNodes++, t.parent && (t.isProjecting() || (t.isProjectionDirty = t.parent.isProjectionDirty), t.isSharedProjectionDirty || (t.isSharedProjectionDirty = !!(t.isProjectionDirty || t.parent.isProjectionDirty || t.parent.isSharedProjectionDirty)), t.isTransformDirty || (t.isTransformDirty = t.parent.isTransformDirty))
            }
            ...
            let ri = {
                ...
                rr = rn("applewebkit/") && !rn("chrome/") ? Math.round : M;
            ...
            function ro(t, e, i) {
                return "position" === t || "preserve-aspect" === t && !(.2 >= Math.abs(nO(e) - nO(i)))
            }
            ...
            function rc(t, e) {
                ...
                return iv(t.current, e ? "pointerenter" : "pointerleave", (n, r) => {
                    if ("touch" === n.pointerType || iM()) return;
                    let s = t.getProps();
            ...
            class rd extends ia {
                mount() {
                    this.unmount = ep(rc(this.node, !0), rc(this.node, !1))
                }
                unmount() {}
            }
            class rp extends ia {
            ...
            class rv extends ia {
                constructor() {
                    super(...arguments), this.removeStartListeners = M, this.removeEndListeners = M, this.removeAccessibleListeners = M, this.startPointerPress = (t, e) => {
                ...
                startPress(t, e) {
                    ...
                    n && this.node.animationState && this.node.animationState.setActive("whileTap", !0), i && k.postRender(() => i(t, e))
                }
                checkPressEnd() {
            ...
            let rT = (0, nn.createContext)({
                    transformPagePoint: t => t,
                    isStatic: !1,
                    reducedMotion: "never"
                }),
                rS = (0, nn.createContext)({}),
                rA = "undefined" != typeof window,
                rV = rA ? nn.useLayoutEffect : nn.useEffect,
                rM = (0, nn.createContext)({
                    strict: !1
                });
            ...
            let rD = {
                ...
                rR = {};
            for (let t in rD) rR[t] = {
                isEnabled: e => rD[t].some(t => !!e[t])
            };
            let rL = Symbol.for("motionComponentSymbol"),
                rF = ["animate", "circle", "defs", "desc", "ellipse", "g", "image", "line", "filter", "marker", "mask", "metadata", "path", "pattern", "polygon", "polyline", "rect", "stop", "switch", "symbol", "svg", "text", "tspan", "use", "view"];
            ...
            function rI(t, e, i, n) {
                for (let i in rB(t, e, void 0, n), e.attrs) t.setAttribute(rO.has(i) ? i : e3(i), e.attrs[i])
            }
            ...
            let rW = t => (e, i) => {
                ...
                rY = (t, e) => e && "number" == typeof t ? e.transform(t) : t,
                rG = {
                    x: "translateX",
                    y: "translateY",
                    z: "translateZ",
            ...
            function rJ(t, {
                ...
                d.transform && (m && (p.transform = d.transform), delete d.transform), m && (void 0 !== r || void 0 !== s || p.transform) && (p.transformOrigin = function(t, e, i) {
                    let n = rq(e, t.x, t.width),
                        r = rq(i, t.y, t.height);
                    return `${n} ${r}`
                }(m, void 0 !== r ? r : .5, void 0 !== s ? s : .5)), void 0 !== e && (d.x = e), void 0 !== i && (d.y = i), void 0 !== n && (d.scale = n), void 0 !== o && function(t, e, i = 1, n = 0, r = !0) {
                    t.pathLength = 1;
                    let s = r ? r_ : rZ;
            ...
            let r2 = new Set(["animate", "exit", "variants", "initial", "style", "values", "variants", "transition", "transformTemplate", "custom", "inherit", "onBeforeLayoutMeasure", "onAnimationStart", "onAnimationComplete", "onUpdate", "onDragStart", "onDrag", "onDragEnd", "onMeasureDragConstraints", "onDirectionLock", "onDragTransitionEnd", "_dragX", "_dragY", "onHoverStart", "onHoverEnd", "onViewportEnter", "onViewportLeave", "globalTapTarget", "ignoreStrict", "viewport"]);

            function r3(t) {
                return t.startsWith("while") || t.startsWith("drag") && "draggable" !== t || t.startsWith("layout") || t.startsWith("onTap") || t.startsWith("onPan") || t.startsWith("onLayout") || r2.has(t)
            }
            let r9 = t => !r3(t);
            try {
                (i7 = require("@emotion/is-prop-valid").default) && (r9 = t => t.startsWith("on") ? !r3(t) : i7(t))
            } catch (t) {}
            let r4 = {
                    current: null
                },
            ...
            class si {
                ...
                constructor({
                    ...
                    this.latestValues = a, this.baseTarget = {
                        ...
                        ...a
                    } : {}, this.renderState = l, this.parent = t, this.props = e, this.presenceContext = i, this.depth = t ? t.depth + 1 : 0, this.reducedMotionConfig = n, this.options = o, this.blockInitialAnimation = !!r, this.isControllingVariants = rE(e), this.isVariantNode = rC(e), this.isVariantNode && (this.variantChildren = new Set), this.manuallyAnimateOnMount = !!(t && t.current);
                    let {
                        willChange: u,
                        ...h
                ...
                unmount() {
                    for (let t in r8.delete(this.current), this.projection && this.projection.unmount(), D(this.notifyUpdate), D(this.render), this.valueSubscriptions.forEach(t => t()), this.valueSubscriptions.clear(), this.removeFromVariantTree && this.removeFromVariantTree(), this.parent && this.parent.children.delete(this), this.events) this.events[t].clear();
                ...
                bindToMotionValue(t, e) {
                    ...
                    let n = m.has(t),
                        r = e.on("change", e => {
                            this.latestValues[t] = e, this.props.onUpdate && k.preRender(this.notifyUpdate), n && this.projection && (this.projection.isTransformDirty = !0)
                        }),
                ...
                update(t, e) {
                    ...
                    this.prevMotionValues = function(t, e, i) {
                        for (let n in e) {
                            ...
                            else if (e4(s)) t.addValue(n, e2(r, {
                                owner: t
                            }));
                            else if (s !== r) {
                                if (t.hasValue(n)) {
                ...
                readValue(t, e) {
                    ...
                    return null != n && ("string" == typeof n && (G(n) || Y(n)) ? n = parseFloat(n) : !st(n) && tY.test(e) && (n = t0(t, e)), this.setBaseTarget(t, e4(n) ? n.get() : n)), e4(n) ? n.get() : n
                }
                setBaseTarget(t, e) {
                    this.baseTarget[t] = e
                }
            ...
            class ss extends sn {
                ...
                readValueFromInstance(t, e) {
                    ...
                    return e = rO.has(e) ? e : e3(e), t.getAttribute(e)
                }
                scrapeMotionValuesFromProps(t, e, i) {
                    return rN(t, e, i)
                }
            ...
            let so = (nt = {
                        ...
                        let o = (0, nn.forwardRef)(function(t, e) {
                            ...
                            if (!h && rA) {
                                ...
                                l = t.MeasureLayout, c.visualElement = function(t, e, i, n, r) {
                                    ...
                                    let {
                                        visualElement: a
                                    } = (0, nn.useContext)(rS), l = (0, nn.useContext)(rM), u = (0, nn.useContext)(nr), h = (0, nn.useContext)(rT).reducedMotion, c = (0, nn.useRef)();
                                    ...
                                    return rV(() => {
                                        d && (m.current = !0, window.MotionIsMounted = !0, d.updateFeatures(), nc.render(d.render), v.current && d.animationState && d.animationState.animateChanges())
                                    }), (0, nn.useEffect)(() => {
                            ...
                            return (0, ni.jsxs)(rS.Provider, {
                                value: c,
                                children: [l && c.visualElement ? (0, ni.jsx)(l, {
                                    visualElement: c.visualElement,
                                    ...u
                                }) : null, n(s, t, (o = c.visualElement, (0, nn.useCallback)(t => {
                                    t && d.mount && d.mount(t), o && (t ? o.mount(t) : o.unmount()), e && ("function" == typeof e ? e(t) : iE(e) && (e.current = t))
                                ...
                                let o = (rj(e) ? function(t, e, i, n) {
                                        ...
                                        let i = {},
                                            n = function(t, e) {
                                                let i = t.style || {},
                                                    n = {};
                                                return r5(n, i, t), Object.assign(n, function({
                                                    transformTemplate: t
                                                }, e) {
                                                    return (0, nn.useMemo)(() => {
                                                        let i = rz();
                                                        return rK(i, e, t), Object.assign({}, i.vars, i.style)
                                                    }, [e])
                                                }(t, e)), n
                                            }(t, e);
                                    ...
                                    a = function(t, e, i) {
                                        let n = {};
                                        for (let r in t)("values" !== r || "object" != typeof t.values) && (r9(r) || !0 === i && r3(r) || !e && !r3(r) || t.draggable && r.startsWith("onDrag")) && (n[r] = t[r]);
                                        return n
                                    }(i, "string" == typeof e, t),
                                    l = e !== nn.Fragment ? {
                                        ...a,
                ...
                am = so("feBlend"),
                af = so("feColorMatrix"),
                av = so("feComponentTransfer"),
                ag = so("feComposite"),
                ay = so("feConvolveMatrix"),
                ax = so("feDiffuseLighting"),
                aP = so("feDisplacementMap"),
                ab = so("feDistantLight"),
                aw = so("feDropShadow"),
                aT = so("feFlood"),
                aS = so("feFuncA"),
                aA = so("feFuncB"),
                ...
                aL = so("feOffset"),
                aF = so("fePointLight"),
                aj = so("feSpecularLighting"),
                aB = so("feSpotLight"),
                aO = so("feTile"),
                aI = so("feTurbulence"),
                aU = so("foreignObject"),
                a$ = so("linearGradient"),
                aN = so("radialGradient"),
                aW = so("textPath")
        }
    }
]);